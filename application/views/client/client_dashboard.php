...
<head>
    ...
    <link href="<?= base_url('assets/css/client-dashboard.min.css') ?>" rel="stylesheet">
</head>
...
<body id="page-top">
    ...
    <div id="wrapper">
        <!-- Sidebar -->
        <?php $this->load->view('includes/client_sidebar'); ?>
        <!-- End of Sidebar -->
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <!-- Main Content -->
            <div id="content">
                <?php $this->load->view('includes/client_topbar'); ?>

                <!-- Begin Page Content -->
                <div class="container-fluid">
                    <!-- Page Heading -->
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Gestion des Dossiers Client</h1>
                    ...
                    <div class="row mb-4">
                        <div class="col-lg-12">
                            <p class="text-muted">Client: Palais Jad Mahal</p>
                            <ul class="nav nav-tabs">
                                <li class="nav-item">
                                    <a class="nav-link active" href="#">Dossier 1: Documents Requis</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="#">Dossier 2: Documents Supplémentaires</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="#">Dossier 3: Documents Archivés</a>
                                </li>
                            </ul>
                        </div>
                    </div>
