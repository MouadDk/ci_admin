...
$route['admins/profile'] = 'Admins/profile';

$route['user_management'] = 'User_management/index';
$route['user_management/save'] = 'User_management/save';
$route['user_management/update/(:num)'] = 'User_management/update/$1';
$route['user_management/delete/(:num)'] = 'User_management/delete/$1';

$route['cleanup/sync_dossiers'] = 'Cleanup/sync_dossiers';
